  ...
  return (
    <div className="mt-4">
          ...
          <div className='flex flex-row items-center justify-center gap-4 mt-3'>
            ...
            <motion.li initial={{y:100, opacity:0}} animate={{y:0, opacity:1}} transition={{delay:0.5, duration:.5}} className='flex flex-row items-center'>
              <AiFillGithub className='text-6xl'/>
               <a href="https://github.com/igorsantos13" className='text-2xl'>GitHub</a>
            </motion.li> 
            <motion.li initial={{y:100, opacity:0}} animate={{y:0, opacity:1}} transition={{delay:0.7, duration:.5}} className='flex flex-row items-center'> 
              <AiFillLinkedin className='text-6xl'/>
              <a href="https://www.linkedin.com/in/igorsantosdev/" className='text-2xl'>LinkedIn</a>
            </motion.li>
            <motion.li initial={{y:100, opacity:0}} animate={{y:0, opacity:1}} transition={{delay:0.9, duration:.5}} className='flex flex-row items-center'> 
